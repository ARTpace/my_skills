---
name: cnb-skill
description: "通过 OpenAPI 与 CNB（云原生构建）平台交互。管理组织、仓库、Issue、PR、合并请求、流水线、制品、 工作区、成员等。使用`cnb` CLI 进行 CRUD 操作。当用户提及 CNB、云原生构建，或需要管理 CNB 资源（如仓库、Issue、PR、流水线、制品库）时触发。"
version: 1.0.0
