---
name: cos-vectors
description: "通过 cos-python-sdk-v5 CosVectorsClient 管理腾讯云 COS 向量桶。完整生命周期：创建/删除/列出向量桶、管理桶策略、创建/查询/列出/删除索引、插入/更新/获取/列出/删除向量和相似度搜索。当用户提及 COS向量、向量桶、vector bucket 或腾讯云相似度搜索时使用。"
---
