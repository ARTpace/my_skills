...
description: "精选的 54 个 DESIGN.md 文件集合，来源于真实面向开发者的网站（Vercel、Stripe、Linear、Notion、Figma 等）。当用户想要构建匹配特定品牌设计系统的 UI、需要 DESIGN.md 模板、询问已知产品的设计令牌/颜色方案/字体，或说'make it look like [brand]'时使用。加载匹配的介绍文件并用作设计规范。"
