---
name: pdf
description: "PDF 处理技能。当用户需要对 PDF 文件执行任何操作时使用此技能。包括：从 PDF 读取或提取文本/表格、合并或拆分多个 PDF、旋转页面、添加水印、创建新 PDF、填写 PDF 表单、加密/解密 PDF、提取图片，以及对扫描的 PDF 进行 OCR 以使其可搜索。如果用户提到 .pdf 文件或要求生成 PDF，请使用此技能。"
