---
name: workrally
description: "WorkRally CLI 工具集 — 面向 AI Agent 的 AIGC 漫剧视频创作全流程工具。支持 AI 生图、AI 生视频、项目管理、资产库、媒资管理、无限画布、文件上传下载等。当用户要求生成图片、生成视频、管理项目、上传文件、下载素材、管理素材，或通过命令行与 WorkRally 平台交互时使用。"
version: 2.3.1
