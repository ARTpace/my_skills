---
name: lark-unified
description: "统一飞书/Lark CLI 套件，覆盖消息、文档、协作、日程等功能。提供跨 11 个业务领域的 200+ 命令，包括即时通讯（IM）、云文档、电子表格、多维表格、日历、邮件、任务、Wiki、视频会议和自定义集成。当通过 CLI 使用飞书/飞书，或需要了解飞书 API 功能时使用：发送/接收消息、管理文档和文件、创建电子表格、管理任务和日历、搜索对话、构建自定义工作流程，或访问任何飞书业务应用。"
version: "1.0.0"
