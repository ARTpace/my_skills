---
id: moneyclaw/smart-file-organizer
owner_id: moneyclaw
...
### 安装步骤
1. **购买技能**：在clawd市场购买智能文件整理助手
2. **下载技能包**：购买后下载 `smart-file-organizer-v1.0.0.zip`
3. **解压文件**：解压到任意目录
4. **运行安装**：打开终端，进入解压目录
5. **开始使用**：按照以下示例使用
...
### 文档资源
- **用户手册**: [查看完整文档](docs/)
- **视频教程**: [观看使用演示](https://moneyclaw.ai/tutorials)
- **社区论坛**: [获取帮助](https://clawd.org.cn/forum)

### 更新日志
- **v1.0.0** (2024-03-05): 初始发布
  - 智能文件分类
  - 智能重命名
  - 重复文件检测
  - 安全备份系统
...
### 30天无条件退款
购买后30天内，如对产品不满意，可申请全额退款。

### 退款流程
1. 发送邮件至 refund@moneyclaw.ai
2. 提供购买凭证
3. 收到退款确认
4. 3-5个工作日内退款到账
...
### 企业定制
需要批量授权或定制功能？联系我们：
- **邮箱**: enterprise@moneyclaw.ai
- **电话**: +1-800-MONEYCLAW
- **官网**: https://moneyclaw.ai/enterprise
