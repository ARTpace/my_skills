---
name: admapix
description: "广告情报与应用分析助手。搜索广告创意、分析应用、查看排行榜、追踪下载量/收入获取市场洞察。在 https://www.admapix.com 获取 API Key。触发词：找素材、搜广告、广告素材、竞品分析、广告分析、排行榜、下载量、收入分析、市场分析、投放分析、App分析、出海分析、search ads、find creatives、ad spy、ad analysis、app ranking、download data、revenue、market analysis、app intelligence、competitor analysis、ad distribution。"
